...
<head>
	...
	<title>Интернет-магазин канцелярских товаров</title>
</head>
<body>
<div id="block-body">
<?php	
...
<ul id="sorting-list">
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-asc" >Цена по возрастанию</a></li>
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-desc" >Цена по убыванию</a></li>
